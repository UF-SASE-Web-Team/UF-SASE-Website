export const InternsFAQ: Array<{ question: string; answer: string | React.ReactNode }> = [
  {
...
export const SetFAQ: Array<{ question: string; answer: string | React.ReactNode }> = [
  {
    question: "How do I sign up?",
    answer: (
      <>
...
export const SportsFAQ: Array<{ question: string; answer: string | React.ReactNode }> = [
  {
    question: "How do I sign up?",
    answer: (
      <>
...
export const SwtFAQ: Array<{ question: string; answer: string | React.ReactNode }> = [
  {
    question: "How do I sign up?",
    answer: (
      <>
